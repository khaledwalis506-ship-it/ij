...
$(function () {
  ...
  var accent = (getComputedStyle(document.documentElement).getPropertyValue('--brand-accent') || 'rgba(255, 152, 0, 1)').trim();
  var dark = (getComputedStyle(document.documentElement).getPropertyValue('--brand-dark') || '#0b1220').trim();
  var light = (getComputedStyle(document.documentElement).getPropertyValue('--brand-white') || '#ffffff').trim();
